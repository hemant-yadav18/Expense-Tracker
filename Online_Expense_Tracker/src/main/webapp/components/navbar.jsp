		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<c:if test="${ empty loginUser }">
              	...
              	<c:if test="${not empty loginUser }">
					...
					href="home.jsp">  Home</a>
              	   ...
              	   <li class="nav-item"><a class="nav-link active"
					href="add_expense.jsp"><i class="fa-solid fa-plus"></i>  Add Expense</a>
				</li>

				<li class="nav-item"><a class="nav-link active "
					href="view_expense.jsp" tabindex="-1"><i class="fa-solid fa-list"></i> view Expense</a></li>
              	</c:if>
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				<c:if test="${not empty loginUser }">
					...
					<li class="nav-item"><a class="nav-link active"
						href="#"><i class="fa-regular fa-circle-user"></i> ${ loginUser.fullname}</a>
					</li>
